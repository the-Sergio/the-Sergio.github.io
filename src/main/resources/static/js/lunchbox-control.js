...
function setMaxPrice() {
	alert("HI!");
	mPrice = parseFloat($('#max_price').val());
	$.ajax({
		type: "GET",
		...
		success: function(result) {
			UID = result;
			$('#dynContent').html("<center><p></p><label>Lunchbox Builder</label></center><div class=\"Lunchbox_Foods\"></div><div class=\"Foods_Under\"></div>");
            getUserLunchbox();
            getPriceTableUnder();
		},
       ...
       $.ajax(
				{
					...
					success : function(result) {
						var test = "<table id = \"ResultTable\" border = \"3\" align=\"center\" width=\"50%\" style=\"float: right\"><tr><td width=\"20%\">Location</td><td width=\"60%\">Item</td><td width=\"20%\">Price</td><td></td></tr>";
...
function getUserLunchbox() {
	$.ajax({
    		...
    		data: {},
    		success: function(result) {
    			var pageContent = "<table id = \"ResultTable\" border = \"3\" align=\"center\" width=\"50%\" style=\"float: left\"><tr><td width=\"20%\">Location</td><td width=\"60%\">Item</td><td width=\"20%\">Price</td></tr>";
